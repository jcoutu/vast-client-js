    ...
    describe '#constructor', ->
        ...
        describe '#load', =>
            ...
            it 'should have called impression urls', =>
                _eventsSent[0].should.eql ['http://example.com/wrapper-impression', 'http://example.com/wrapper-extension', 'http://example.com/impression1', 'http://example.com/impression2', 'http://example.com/impression3']
